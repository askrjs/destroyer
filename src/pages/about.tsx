  ...
  return (
    <Page>
      <PageHeader
        ...
        description="Destroyer is the production-shaped integration target for the complete Askr platform."
        actions={
      ...
      <Card variant="raised">
        <CardHeader>
          ...
          <CardDescription>
            The operations workspace is a real application boundary, not a component gallery.
          </CardDescription>
        </CardHeader>
        <CardContent>
