...
export const scenarioCatalog = [
  ...
  scenario("S15", "/login", "Immediate pre-hydration interaction preserves server liveness", "before hydration"),
  ...
  scenario("S23", "/metrics", "Summary, metrics, and logs fail or hold independently", "independent Metrics sections"),
